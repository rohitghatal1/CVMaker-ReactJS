            ...
            <div class="container">
                <div class="left-section">
                    ...
                    <div class="section summary">
                        <h3>SUMMARY</h3>
                        <ul>
                            <li><i class="fas fa-phone"></i> +977 1 9856 444 888</li>
                            <li><i class="fas fa-envelope"></i> youremail@domain.com</li>
                            <li><i class="fas fa-map-marker-alt"></i> Dillibazar 13, Kathmandu</li>
                            <li><i class="fab fa-facebook"></i> Facebook.com/archana.56</li>
                        </ul>
                    </div>

                    <div class="section awards">
                        <h3>AWARDS</h3>
                        <p><strong>Best Travel App</strong><br />Vue Intacts / 2020 / Kathmandu<br />Improve information architecture of ABC's Web site by assisting with</p>
